...
- [ ] cp2077-coop/src/runtime/NpcController.reds:1  dynamic AI reinforcements missing (design)
- [ ] cp2077-coop/src/server/DedicatedMain.cpp:1  /unstuckcar command not implemented (design)
- [ ] cp2077-coop/src/runtime/Inventory/Vendor.reds:1  vendor restock timer absent (design)
